---
title: Cómo configurar tu Plan Único de Cuentas (PUC)
description: Configura y revisa el Plan Único de Cuentas de una empresa demo.
module: contabilidad
...
# Cómo configurar tu Plan Único de Cuentas (PUC)

Elige el Plan Único de Cuentas que utilizará tu empresa nueva y déjalo disponible para comenzar los registros contables.
...
### 1. Elige cómo configurar el PUC
...
1. Ubica la sección **Cargar un PUC predeterminado**.
2. En el campo **Tipo**, selecciona **Comercial**.
3. Selecciona **Cargar PUC**.
...
Cuando el PUC esté disponible, revisa sus grupos principales y utiliza las flechas laterales para desplegar las cuentas. También puedes usar el campo **Consultar** para localizar una cuenta.

Si necesitas una copia del plan, utiliza la opción **Descargar** disponible en la parte superior.

## Resultado esperado

El Plan Único de Cuentas queda disponible para utilizarlo en los registros contables de la empresa demo.

## Errores frecuentes

### No aparece la opción PUC

Comprueba que estés dentro de una empresa y que tengas acceso al módulo de Contabilidad.

### No puedes cargar el plan semilla
...
### No encuentras una cuenta

Utiliza el campo **Consultar** o despliega el grupo contable correspondiente.
