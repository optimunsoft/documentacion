...
* `docs/00-contexto/`: Investigaciones iniciales, mapas de la app, glosario y propuestas de arquitectura.
* `docs/assets/img/`: Capturas de pantalla e imágenes optimizadas para la documentación.
* `CONTRIBUTING.md`: Guía con el flujo de Git, convenciones de nombres y estándares de entrega.

---

## 🚀 Cómo Trabajar en este Repositorio

1. Lee detenidamente el archivo [`CONTRIBUTING.md`](./CONTRIBUTING.md) antes de realizar cualquier cambio.
